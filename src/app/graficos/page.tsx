...
export default function GraficosPage() {
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-1">Gráficos Comparativos: Métricas Operacionais e Financeiras</h1>
        ...
        <div className="flex items-center gap-3 mb-4">
          <span className="inline-flex items-center gap-1.5 bg-emerald-950/60 border border-emerald-800/50 text-emerald-300 text-xs font-medium px-3 py-1 rounded-full">
            ...
            Atualização até 4T25
          </span>
        </div>

        {/* Bloco de texto indexável */}
        <p className="text-slate-400 text-sm leading-relaxed max-w-4xl">
          Compare a evolução trimestral dos principais indicadores operacionais e financeiros dos bancos brasileiros selecionados.
          Selecione a métrica e os bancos desejados em cada painel.
